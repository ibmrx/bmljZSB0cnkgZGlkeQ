...
function showModule(module) {
    ...
    switch (module) {
        case 'show':
            ...
            moduleContent = `
            <p>16/05/2026</p>
            <!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Good Luck For Your Exams</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/tabler-icons.min.css"><style>*{box-sizing:border-box;margin:0;padding:0;}body{background:#060b18;min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:'Segoe UI',sans-serif;padding:2rem;}@keyframes shimmer{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}@keyframes sparkle{0%,100%{opacity:0;transform:scale(0)}50%{opacity:1;transform:scale(1)}}@keyframes streak{0%{opacity:0;transform:translateX(-60px)}60%{opacity:1}100%{opacity:0;transform:translateX(60px)}}@keyframes count-up{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}.exam-card{position:relative;max-width:680px;width:100%;border-radius:20px;padding:3px;background:linear-gradient(135deg,#60a5fa,#c084fc,#f87171,#4ade80,#fbbf24);background-size:300% 300%;animation:shimmer 4s ease infinite;}.card-inner{background:#0a0f1e;border-radius:18px;padding:2.5rem 2rem 2rem;position:relative;overflow:hidden;text-align:center;}.card-inner::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 50% 0%,rgba(96,165,250,0.15) 0%,transparent 70%),radial-gradient(ellipse at 80% 100%,rgba(192,132,252,0.1) 0%,transparent 60%);pointer-events:none;}.badge{display:inline-block;background:rgba(96,165,250,0.15);border:1px solid rgba(96,165,250,0.4);color:#93c5fd;font-size:11px;font-weight:500;letter-spacing:2px;text-transform:uppercase;padding:5px 16px;border-radius:100px;margin-bottom:1.5rem;animation:count-up 0.6s ease both;}.headline{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-bottom:0.5rem;animation:float 4s ease-in-out infinite;}.word{font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;text-shadow:0 0 30px currentColor;animation:count-up 0.7s ease both;}.w5{color:#f87171;animation-delay:0.25s;}.sub{font-size:15px;color:rgba(255,255,255,0.45);margin-top:0.75rem;margin-bottom:1.5rem;letter-spacing:1px;animation:count-up 0.8s 0.3s ease both;opacity:0;animation-fill-mode:forwards;}.divider{display:flex;align-items:center;gap:12px;margin:1.25rem 0;}.divider-line{flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.15),transparent);}.divider-dot{width:6px;height:6px;border-radius:50%;background:#c084fc;box-shadow:0 0 8px #c084fc;}.pills{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-bottom:1.75rem;animation:count-up 0.8s 0.4s ease both;opacity:0;animation-fill-mode:forwards;}.pill{display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:100px;font-size:12px;font-weight:600;letter-spacing:0.5px;}.pill-blue{background:rgba(96,165,250,0.12);border:1px solid rgba(96,165,250,0.35);color:#93c5fd;}.pill-purple{background:rgba(192,132,252,0.12);border:1px solid rgba(192,132,252,0.35);color:#d8b4fe;}.pill-green{background:rgba(74,222,128,0.12);border:1px solid rgba(74,222,128,0.35);color:#86efac;}.pill-red{background:rgba(248,113,113,0.12);border:1px solid rgba(248,113,113,0.35);color:#fca5a5;}.pill i{font-size:14px;}.sparks{position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden;border-radius:18px;}.spark{position:absolute;width:4px;height:4px;border-radius:50%;animation:sparkle var(--d) var(--delay) ease-in-out infinite;}.streak{position:absolute;height:1px;width:40px;border-radius:1px;animation:streak var(--d) var(--delay) ease-in-out infinite;}</style></head><body><div class="exam-card"><div class="card-inner"><div class="sparks"><div class="spark" style="top:10%;left:8%;background:#60a5fa;--d:2.1s;--delay:0s;"></div><div class="spark" style="top:20%;left:92%;background:#c084fc;--d:2.7s;--delay:0.4s;"></div><div class="spark" style="top:70%;left:5%;background:#4ade80;--d:3s;--delay:0.8s;"></div><div class="spark" style="top:80%;left:90%;background:#f87171;--d:2.4s;--delay:1.2s;"></div><div class="spark" style="top:50%;left:50%;background:#fbbf24;--d:1.8s;--delay:0.6s;width:6px;height:6px;"></div><div class="spark" style="top:35%;left:15%;background:#c084fc;--d:2.2s;--delay:1.5s;"></div><div class="spark" style="top:65%;left:78%;background:#60a5fa;--d:2.9s;--delay:0.2s;"></div><div class="streak" style="top:15%;left:0%;background:rgba(96,165,250,0.4);--d:3.5s;--delay:0s;"></div><div class="streak" style="top:55%;left:0%;background:rgba(192,132,252,0.4);--d:4s;--delay:1s;"></div><div class="streak" style="top:85%;left:0%;background:rgba(74,222,128,0.3);--d:3.2s;--delay:2s;"></div></div><div class="badge">✦ Saison des examens ✦</div><div class="headline"><span class="word w5">Bonne Courage :)</span></div><p class="sub">Tu as travaillé dur. Maintenant, montre ce que tu sais faire.</p><div class="divider"><div class="divider-line"></div><div class="divider-dot"></div><div class="divider-line"></div></div><div class="pills"><div class="pill pill-blue"><i class="ti ti-brain"></i> Restez concentré</div><div class="pill pill-purple"><i class="ti ti-clock"></i> Gérer le temps</div><div class="pill pill-green"><i class="ti ti-heart"></i> Rester calme</div><div class="pill pill-red"><i class="ti ti-star"></i> Faites-vous confiance</div></div></div></div></body></html>
            `;
            break;
        case 'rat':
