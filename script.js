...
function showModule(module) {
    ...
    switch (module) {
        case 'show':
            ...
            moduleContent = `
                <div style="position:relative;max-width:680px;width:100%;border-radius:20px;padding:3px;background:linear-gradient(135deg,#60a5fa,#c084fc,#f87171,#4ade80,#fbbf24);background-size:300% 300%;animation:shimmer 4s ease infinite,pulse-ring 3s ease-in-out infinite;"><style>@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}@keyframes shimmer{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}@keyframes pulse-ring{0%{transform:scale(0.95);opacity:0.7}50%{transform:scale(1.03);opacity:1}100%{transform:scale(0.95);opacity:0.7}}@keyframes sparkle{0%,100%{opacity:0;transform:scale(0)}50%{opacity:1;transform:scale(1)}}@keyframes streak{0%{opacity:0;transform:translateX(-60px)}60%{opacity:1}100%{opacity:0;transform:translateX(60px)}}@keyframes count-up{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}</style><div style="background:#0a0f1e;border-radius:18px;padding:2.5rem 2rem 2rem;position:relative;overflow:hidden;text-align:center;"><div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden;border-radius:18px;"><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#60a5fa;top:10%;left:8%;animation:sparkle 2.1s 0s ease-in-out infinite;"></div><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#c084fc;top:20%;left:92%;animation:sparkle 2.7s 0.4s ease-in-out infinite;"></div><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#4ade80;top:70%;left:5%;animation:sparkle 3s 0.8s ease-in-out infinite;"></div><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#f87171;top:80%;left:90%;animation:sparkle 2.4s 1.2s ease-in-out infinite;"></div><div style="position:absolute;width:6px;height:6px;border-radius:50%;background:#fbbf24;top:50%;left:50%;animation:sparkle 1.8s 0.6s ease-in-out infinite;"></div><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#c084fc;top:35%;left:15%;animation:sparkle 2.2s 1.5s ease-in-out infinite;"></div><div style="position:absolute;width:4px;height:4px;border-radius:50%;background:#60a5fa;top:65%;left:78%;animation:sparkle 2.9s 0.2s ease-in-out infinite;"></div><div style="position:absolute;height:1px;width:40px;border-radius:1px;background:rgba(96,165,250,0.4);top:15%;left:0%;animation:streak 3.5s 0s ease-in-out infinite;"></div><div style="position:absolute;height:1px;width:40px;border-radius:1px;background:rgba(192,132,252,0.4);top:55%;left:0%;animation:streak 4s 1s ease-in-out infinite;"></div><div style="position:absolute;height:1px;width:40px;border-radius:1px;background:rgba(74,222,128,0.3);top:85%;left:0%;animation:streak 3.2s 2s ease-in-out infinite;"></div></div><div style="display:inline-block;background:rgba(96,165,250,0.15);border:1px solid rgba(96,165,250,0.4);color:#93c5fd;font-size:11px;font-weight:500;letter-spacing:2px;text-transform:uppercase;padding:5px 16px;border-radius:100px;margin-bottom:1.5rem;animation:count-up 0.6s ease both;font-family:'Segoe UI',sans-serif;">✦ Exam Season ✦</div><div style="display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-bottom:0.5rem;animation:float 4s ease-in-out infinite;"><span style="font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;color:#60a5fa;text-shadow:0 0 30px #60a5fa;animation:count-up 0.7s 0.05s ease both;font-family:'Segoe UI',sans-serif;">GOOD</span><span style="font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;color:#c084fc;text-shadow:0 0 30px #c084fc;animation:count-up 0.7s 0.1s ease both;font-family:'Segoe UI',sans-serif;">LUCK</span><span style="font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;color:#f8fafc;text-shadow:0 0 30px #f8fafc;animation:count-up 0.7s 0.15s ease both;font-family:'Segoe UI',sans-serif;">FOR</span><span style="font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;color:#4ade80;text-shadow:0 0 30px #4ade80;animation:count-up 0.7s 0.2s ease both;font-family:'Segoe UI',sans-serif;">YOUR</span><span style="font-size:clamp(28px,6vw,48px);font-weight:900;letter-spacing:3px;color:#f87171;text-shadow:0 0 30px #f87171;animation:count-up 0.7s 0.25s ease both;font-family:'Segoe UI',sans-serif;">EXAMS</span></div><p style="font-size:15px;color:rgba(255,255,255,0.45);margin-top:0.75rem;margin-bottom:1.5rem;letter-spacing:1px;animation:count-up 0.8s 0.3s ease both;opacity:0;animation-fill-mode:forwards;font-family:'Segoe UI',sans-serif;">You've put in the work. Now go show what you know.</p><div style="display:flex;align-items:center;gap:12px;margin:1.25rem 0;"><div style="flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.15),transparent);"></div><div style="width:6px;height:6px;border-radius:50%;background:#c084fc;box-shadow:0 0 8px #c084fc;"></div><div style="flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.15),transparent);"></div></div><div style="display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-bottom:1.75rem;animation:count-up 0.8s 0.4s ease both;opacity:0;animation-fill-mode:forwards;"><div style="display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:100px;font-size:12px;font-weight:600;letter-spacing:0.5px;background:rgba(96,165,250,0.12);border:1px solid rgba(96,165,250,0.35);color:#93c5fd;font-family:'Segoe UI',sans-serif;">⚡ Stay Focused</div><div style="display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:100px;font-size:12px;font-weight:600;letter-spacing:0.5px;background:rgba(192,132,252,0.12);border:1px solid rgba(192,132,252,0.35);color:#d8b4fe;font-family:'Segoe UI',sans-serif;">⏱ Manage Time</div><div style="display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:100px;font-size:12px;font-weight:600;letter-spacing:0.5px;background:rgba(74,222,128,0.12);border:1px solid rgba(74,222,128,0.35);color:#86efac;font-family:'Segoe UI',sans-serif;">💚 Stay Calm</div><div style="display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:100px;font-size:12px;font-weight:600;letter-spacing:0.5px;background:rgba(248,113,113,0.12);border:1px solid rgba(248,113,113,0.35);color:#fca5a5;font-family:'Segoe UI',sans-serif;">⭐ Trust Yourself</div></div><div style="display:flex;justify-content:center;gap:1px;margin:0 0 1.5rem;animation:count-up 0.8s 0.55s ease both;opacity:0;animation-fill-mode:forwards;"><div style="flex:1;padding:0.9rem 0.5rem;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:12px 0 0 12px;text-align:center;"><div style="font-size:26px;font-weight:800;line-height:1;margin-bottom:4px;color:#60a5fa;font-family:'Segoe UI',sans-serif;">100%</div><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.35);font-family:'Segoe UI',sans-serif;">Effort</div></div><div style="flex:1;padding:0.9rem 0.5rem;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);text-align:center;"><div style="font-size:26px;font-weight:800;line-height:1;margin-bottom:4px;color:#c084fc;font-family:'Segoe UI',sans-serif;">∞</div><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.35);font-family:'Segoe UI',sans-serif;">Potential</div></div><div style="flex:1;padding:0.9rem 0.5rem;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);text-align:center;"><div style="font-size:26px;font-weight:800;line-height:1;margin-bottom:4px;color:#4ade80;font-family:'Segoe UI',sans-serif;">0</div><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.35);font-family:'Segoe UI',sans-serif;">Doubts</div></div><div style="flex:1;padding:0.9rem 0.5rem;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:0 12px 12px 0;text-align:center;"><div style="font-size:26px;font-weight:800;line-height:1;margin-bottom:4px;color:#f87171;font-family:'Segoe UI',sans-serif;">🔥</div><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.35);font-family:'Segoe UI',sans-serif;">Energy</div></div></div><button onclick="this.textContent='YOU GOT THIS! 🔥';setTimeout(()=>this.textContent='Go Crush It! ✦',1800)" style="padding:12px 36px;border-radius:100px;font-size:15px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;background:linear-gradient(135deg,#60a5fa,#c084fc);color:#fff;border:none;cursor:pointer;animation:count-up 0.8s 0.7s ease both;opacity:0;animation-fill-mode:forwards;transition:transform 0.15s,box-shadow 0.15s;font-family:'Segoe UI',sans-serif;">Go Crush It! ✦</button><div style="margin-top:1.5rem;font-size:12px;color:rgba(255,255,255,0.2);letter-spacing:1px;animation:count-up 1s 0.9s ease both;opacity:0;animation-fill-mode:forwards;font-family:'Segoe UI',sans-serif;">✦ &nbsp; prepared · focused · unstoppable &nbsp; ✦</div></div></div>
            `;
            break;
        case 'rat':
...
<p>Résumé : <a href="https://drive.google.com/file/d/1LLCC-21L6HYh5dXn3lLjL_EqPTnb7ySR/view?usp=sharing" target="_blank">Télécharger le PDF</a></p>            
            `;
            break;
        case 'rdm':
